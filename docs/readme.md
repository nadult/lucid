...
There are also [github
workflows](https://github.com/nadult/lucid/blob/main/.github/workflows/test.yml) available, which
build LucidRaster for both platforms (but artifacts are only created for Windows).